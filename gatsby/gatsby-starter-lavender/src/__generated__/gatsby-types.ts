...
type SiteSiteMetadata = {
  ...
  readonly googleAnalytics: Maybe<Scalars['String']>;
};
...
type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark.frontmatter.thumbnail'
  ...
  | 'childMarkdownRemark.frontmatter.thumbnail'
...
type SiteSiteMetadataFilterInput = {
  ...
  readonly thumbnail: Maybe<StringQueryOperatorInput>;
  readonly comment: Maybe<SiteSiteMetadataCommentFilterInput>;
  readonly icon: Maybe<StringQueryOperatorInput>;
  readonly googleAnalytics: Maybe<StringQueryOperatorInput>;
};
...
type SiteFieldsEnum =
  ...
  | 'siteMetadata.comment.utterances'
  | 'siteMetadata.comment.disqusShortName'
  | 'siteMetadata.icon'
...
type SitePageFieldsEnum =
  ...
  | 'pluginCreator.pluginOptions.defer'
...
type ArticleTagsQueryVariables = Exact<{ [key: string]: never; }>;


type ArticleTagsQuery = { readonly allMarkdownRemark: Pick<MarkdownRemarkConnection, 'distinct'> };

type ProfileQueryVariables = Exact<{ [key: string]: never; }>;


type ProfileQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'author' | 'description'>
      & { readonly social: Maybe<Pick<Social, 'github' | 'twitter' | 'facebook' | 'linkedin' | 'instagram'>> }
    )> }> };

type CommentQueryVariables = Exact<{ [key: string]: never; }>;


type CommentQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<{ readonly comment: Maybe<Pick<SiteSiteMetadataComment, 'utterances' | 'disqusShortName'>> }> }> };

type BlogIndexQueryVariables = Exact<{ [key: string]: never; }>;


type BlogIndexQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'siteUrl' | 'thumbnail'>> }>, readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<(
      Pick<MarkdownRemark, 'excerpt'>
      & { readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<Pick<Frontmatter, 'title' | 'description' | 'tags'>> }
    )> } };

type PageNotFoundQueryVariables = Exact<{ [key: string]: never; }>;


type PageNotFoundQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
...
type BlogPostBySlugQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'siteUrl' | 'thumbnail'>> }>, readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'id' | 'tableOfContents' | 'excerpt' | 'html'>
    & { readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<Pick<Frontmatter, 'title' | 'date' | 'description' | 'tags' | 'thumbnail'>> }
