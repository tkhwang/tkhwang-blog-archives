---
title: 'leetcode 931. Minimum Falling Path Sum | medium | dynamic-programming | javascript'
date: '2022-10-21'
tags: ['medium', 'dynamic-programming']
draft: false
summary: 'leetcode 931. Minimum Falling Path Sum | medium | dynamic-programming | javascript'
layout: PostLayout
...
for (let r = 1; r < ROWS; r += 1) {
  for (let c = 0; c < COLS; c += 1) {
    dp[r][c] =
      matrix[r][c] +
      Math.min(dp[r - 1][c - 1] || Infinity, dp[r - 1][c] || Infinity, dp[r - 1][c + 1] || Infinity)
  }
}
```
