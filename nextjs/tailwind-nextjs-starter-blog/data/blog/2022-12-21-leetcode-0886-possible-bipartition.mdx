---
title: 'leetcode 886. Possible Bipartition | medium | bfs | javascript'
date: '2022-12-21'
tags: ['medium', 'bfs']
draft: false
summary: 'leetcode 886. Possible Bipartition | medium | bfs | javascript'
layout: PostLayout
...
where dislikes[i] = [ai, bi] indicates
